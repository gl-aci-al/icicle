...
- Download as ZIP
- Extract it
- Go to chrome://extensions (or your-browser://extensions)
- Click dev mode at top right
- Click Load Unpacked
- Go to the place you extracted (you will likely have to go in icicle-main/icicle-main, which then will have the extension.)
- Done!
# Why make this?
...
- Firefox is unsupported entirely (sorry! - use chromium based browsers)
